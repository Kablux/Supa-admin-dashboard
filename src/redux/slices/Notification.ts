...
import { NotificationsState, SosTab, NotifCategory } from '../../types/common.types';
import { REMINDERS, SOS_DRIVERS, SOS_RIDERS, NOTIFICATIONS } from '../../data/notificationMockData';
...
export const {
  setSosTab, setCategory, markRead, markAllRead, deleteNotification,
